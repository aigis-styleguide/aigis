...
var colorRenderer = require("../renderer/color");
...
var Template = (function() {
  ...
  Template.prototype = {
    ...
    renderColor: function() {
      var html = colorRenderer(this.colors);
      var root = "./";
    ...
    renderSidemenu: function(root) {
      ...
      _.each(category, function(category) {
        category.href = path.join(root, "category", category.path, "index.html");
        category.base = _.dropRight(category.path.split("/")).join("/");
        category.root = _.first(category.path.split("/"));
        category.parent = _.last(category.base.split("/"));
      });
